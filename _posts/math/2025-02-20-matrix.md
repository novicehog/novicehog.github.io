...
우선, 예를 들어 어떠한 점 P1이 `Z축을 중심으로 회전`을 하여 P2의 위치로 이동한다고 가정해보자.<br>

![회전 예시](https://github.com/user-attachments/assets/682de8ec-fb62-4834-ab92-6ede440618d6)

이 회전을 다음과 같이 나타낼 수 있다.

![좌표값 시각화](https://github.com/user-attachments/assets/6af15612-db00-40fe-8b23-7db090b0fe9a)